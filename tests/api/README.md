...
generated by `make fixtures` from the Rust circuits crate and sign the deterministic
placeholder sighash `Blake2b-256("ZALLY_SIGHASH_V0")`.
...
To regenerate after changes to the sighash scheme:
